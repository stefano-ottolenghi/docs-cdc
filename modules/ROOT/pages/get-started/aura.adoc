...
Admin users can tweak the CDC mode for a database using the Aura instance options.
To access the setting, access the instance options through the three dots on the instance card and select *Edit CDC Enrichment Mode*.
...
To disable CDC on a database, access the instance options through the three dots on the instance card, select *Edit CDC Enrichment Mode*, and set it to `OFF`.
